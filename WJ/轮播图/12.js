function mySwiper(container, time = 2500) {
  let el = container.querySelector('.banner-container')
  ...
  let itemList = el.querySelectorAll('li')
  let elLength = el.querySelectorAll('li').length
  ...
  function render() {
    if (animationMark) return;
    el.style.left = (-1) * screenWidth * index + 'px';
