let data = [
  {value:'啊啊啊啊啊啊啊啊啊啊啊啊',time:5,color:'red',speed:1,fontSize:22},
  {value:'哦哦哦哦哦哦哦哦哦',time:10,color:'green',speed:1,fontSize:22},
  {value:'哇哇哇哇哇哇哇哇哇哇哇哇',time:15,color:'white',speed:1,fontSize:22},
  {value:'咩咩咩咩咩咩咩咩咩咩咩',time:15,speed:1,fontSize:22}
]
...
class CanvasBarrage {
  ...
  render(){
    ...
    if(this.isPaused === false){
      //通过raf渲染动画，request animation frame  递归进行渲染
  ...
  renderBarrage(){
    ...
    this.barrages.forEach(barrage => {
      ...
      if(!barrage.flag && time >= barrage.time){
        ...
        //弹幕需要从右往左渲染，所以X轴坐标减去当前弹幕的speed即可
